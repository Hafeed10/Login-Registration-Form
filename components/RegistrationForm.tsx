	...
	return (
		<PageWrapper>
			<div className="flex justify-center items-center">
				<div  className="w-full max-w-sm p-4 py-8 border border-gray-200 rounded-lg shadow-md sm:p-6 sm:py-10 md:p-8 md:py-14 bg-black bg-transparent dark:bg-transparent">
					<form
						action=""
